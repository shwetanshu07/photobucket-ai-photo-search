...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://rw9cv8zi2b.execute-api.us-east-1.amazonaws.com/prod';
    ...
    apigClient.photosFilenamePut = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, ['filename', 'Content-Type', 'x-amz-meta-customLabels'], ['body']);
        
        var photosFilenamePutRequest = {
            verb: 'put'.toUpperCase(),
            path: pathComponent + uritemplate('/photos/{filename}').expand(apiGateway.core.utils.parseParametersToObject(params, ['filename', ])),
        ...
        return apiGatewayClient.makeRequest(photosFilenamePutRequest, authType, additionalParams, config.apiKey);
    };
    
    
    apigClient.photosFilenameOptions = function (params, body, additionalParams) {
        if(additionalParams === undefined) { additionalParams = {}; }
        
        apiGateway.core.utils.assertParametersDefined(params, [], ['body']);
        
        var photosFilenameOptionsRequest = {
            verb: 'options'.toUpperCase(),
            path: pathComponent + uritemplate('/photos/{filename}').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
            headers: apiGateway.core.utils.parseParametersToObject(params, []),
            queryParams: apiGateway.core.utils.parseParametersToObject(params, []),
            body: body
        };
        ...
        return apiGatewayClient.makeRequest(photosFilenameOptionsRequest, authType, additionalParams, config.apiKey);
    };
